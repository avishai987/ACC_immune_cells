  ...
  if (caf == F){
    pg$plot$data  %<>%  mutate(lum_or_myo = if_else(condition = grepl(pattern = "Luminal",x = Var2),
      ...
      mutate(direction =if_else(condition = grepl(pattern = "-Luminal|-Myo",x = Var2),
                                    true = "cancer->immune" ,false = "immune->cancer")) 
...
print_tab(plt = 
            my_plot_cpdb(cell_type1 = 'CD|Treg|gdT', cell_type2 = 'Luminal pri|Myo pri', scdata = acc_cancer_cd45_caf,
                      idents = 'cell_type', means = means, pvals = pvals,
...
print_tab(plt = 
            my_plot_cpdb(cell_type1 = 'CD|Treg|gdT', cell_type2 = 'Luminal LN|Myo LN', scdata = acc_cancer_cd45_caf,
                      idents = 'cell_type', means = means, pvals = pvals,
...
print_tab(plt = 
            my_plot_cpdb(cell_type1 = 'CD|Treg|gdT', cell_type2 = 'CAF', scdata = acc_cancer_cd45_caf,
                      idents = 'cell_type', means = means, pvals = pvals,
...
print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Luminal pri',cell_type2_b = "Myo",gene.family = "Costimulatory")
,title = "unique in luminal pri")


print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Myo pri',cell_type2_b = "Luminal",gene.family = "Costimulatory")
,title = "unique in myo pri")

print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Luminal LN',cell_type2_b = "Myo",gene.family = "Costimulatory")
,title = "unique in luminal LN")


print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Myo LN',cell_type2_b = "Luminal",gene.family = "Costimulatory")
...
print_tab(my_plot_cpdb(cell_type1 = 'CD|Treg|gdT', cell_type2 = 'Luminal pri|Myo pri', scdata = acc_cancer_cd45_caf,
          idents = 'cell_type', means = means, pvals = pvals,
...
print_tab(my_plot_cpdb(cell_type1 = 'CD|Treg|gdT', cell_type2 = 'Luminal LN|Myo LN', scdata = acc_cancer_cd45_caf,
          idents = 'cell_type', means = means, pvals = pvals,
          gene.family = 'coinhibitory',return_table = F,max_size = 4,p.adjust.method = "fdr",keep_significant_only = F,cluster_rows = F)+
...
print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Luminal LN',cell_type2_b = "Myo LN",gene.family = "coinhibitory")
,title = "unique in luminal LN")


print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Myo LN',cell_type2_b = "Luminal LN",gene.family = "coinhibitory")
,title = "unique in myo LN")


print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Luminal pri',cell_type2_b = "Myo pri",gene.family = "coinhibitory")
,title = "unique in luminal pri")

print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Myo pri',cell_type2_b = "Luminal pri",gene.family = "coinhibitory")
,title = "unique in myo pri")
```
...
print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Luminal LN',cell_type2_b = "Myo LN",gene.family = "chemokines")
,title = "unique in luminal LN")


print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Myo LN',cell_type2_b = "Luminal LN",gene.family = "chemokines")
,title = "unique in myo LN")


print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Luminal pri',cell_type2_b = "Myo pri",gene.family = "chemokines")
,title = "unique in luminal pri")

print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Myo pri',cell_type2_b = "Luminal pri",gene.family = "chemokines")
,title = "unique in myo pri")
```
...
print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Luminal LN',cell_type2_b = "Myo LN",genes = genes)
,title = "unique in luminal LN")


print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Myo LN',cell_type2_b = "Luminal LN",genes = genes)
,title = "unique in myo LN")


print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Luminal pri',cell_type2_b = "Myo pri",genes = genes)
,title = "unique in luminal pri")

print_tab(plt = 
            uniq_interactions(cell_type1 = 'CD|Treg|gdT',cell_type2_a  = 'Myo pri',cell_type2_b = "Luminal pri",genes = genes)
,title = "unique in myo pri")
```
...
my_plot_cpdb(cell_type1 = 'CD|Treg|gdT|Den', cell_type2 = 'Luminal pri|Myo pri', scdata = acc_cancer_cd45_caf,
    idents = 'cell_type', means = means, pvals = pvals,
